...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const child = new ChildDiv(parent as ParentDiv, 50, '#000000');

    const parent2 = new ParentDiv('#44c9eb', '100%', '100%');
    const child2 = new ChildDiv(parent2 as ParentDiv, 50, '#000000');

    const parent3 = new ParentDiv('#eb7044', '100%', '100%');
    const child3 = new ChildDiv(parent3 as ParentDiv, 50, '#000000');

    const parent4 = new ParentDiv('#fa9052', '100%', '100%');
    const child4 = new ChildDiv(parent4 as ParentDiv, 50, '#000000');
});
